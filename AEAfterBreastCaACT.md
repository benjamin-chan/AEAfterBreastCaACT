...
From the concept paper Joy sent to NCI:
...
```r
study <- c("HIP", "Kopparberg", "CNBSS-1", "Malmö", "Stockholm", "Östergötland", 
    "Gothenberg", "Age")
...
##  0.8513    NA 0.7518 0.9639 0.7518 0.9639
```
...
## 
##   logLik  deviance       AIC       BIC  
##  40.3055  -80.6110  -76.6110  -76.7192  
## 
